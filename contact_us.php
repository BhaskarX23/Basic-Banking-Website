...
<body style="background-image:url('statics/contactpage.jpg'); padding-top:8%; background-size: 100% 100%; background-repeat: no-repeat;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <a href="index.php"><img src="statics\banklogo.png" alt=""
                    style="height: 80px; margin-left:-19px"></a>
