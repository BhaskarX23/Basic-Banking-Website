...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/banklogo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/banklogo.png">
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\banklogo.png" alt=""
                    style="height: 80px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="all_cust.php">View Our Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap" href="about_us.php">About</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <div class="container-large"
        style="color:white; height:70vh; width: 100%; padding:8% 2% 2% 2%; background-color:#416885; background-image: url('statics/bluewave3.jpg'); background-size: 100% 100%; background-repeat: no-repeat;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center; color:#140606"><b>Welcome to <br> Mega
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/moneypage.jpg" class="zoomin" alt="" style="width:0px; mix-blend-mode:darken;">
            </div>
        </div>
    </div>
    <!-- <img src="statics/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1"> -->
    <img src="statics/abstbg3.jpg" alt="" style="width:100%; position:absolute; z-index:-1; object-fit: cover; height: 80vh" >

    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black; border-radius:10px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:#140606;"><b>Our Awesome Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                <div class="col-lg">
                        <div
                            style="background-color:#00274e; color:white; width: 90%; border-radius:10px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
