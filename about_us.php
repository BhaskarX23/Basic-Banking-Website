...
<body style="background-color:#212529;">
    ...
    <style>
        ...
        body{
            background-color:#416885!important;
        }
    </style>
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap active" href="about_us.php">About</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:#08023080; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/banklogo.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Bhaskar Malwani</h1>
            <p style="color:#08023080;"><b>Intern at Sparks Foundation <br> Bhagwan Parshuram Institute of Technology, Delhi</b></p>
    </center>
